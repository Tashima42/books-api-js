...
var _LinksController = _interopRequireDefault(require("../controllers/LinksController"));
...
*/
{
  method: "get",
  path: "/",
  controller: _LinksController["default"].getAllLinks
},
/**
...
*/
{
  method: "get",
  path: "/:id",
  controller: _LinksController["default"].getOneLink
},
/**
...
*/
{
  method: "delete",
  path: "/:id",
  controller: _LinksController["default"].deleteLink
},
/**
...
*/
{
  method: "post",
  path: "/new",
  controller: _LinksController["default"].insertLink
},
/**
...
*/
{
  method: "put",
  path: "/:id",
  controller: _LinksController["default"].updateLink
}];
